        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <?= form_open_multipart('admin/page/edit/' . $page['id_halaman']); ?>

                    <div class="form-group">
                        <label for="title">Judul Halaman</label>
                        <input type="text" class="form-control" id="judul" name="judul" value="<?= $page['judul'] ?>" placeholder="Judul">
                    </div>

                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">Isi Halaman</label>
                        <textarea class="form-control" id="body" name="isi" rows="10" value="<?= $page['isi'] ?>"><?= $page['isi'] ?></textarea>
                    </div>
                    <div class=" form-group">
